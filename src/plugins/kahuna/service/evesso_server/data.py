SCOPE = "publicData esi-calendar.respond_calendar_events.v1 esi-calendar.read_calendar_events.v1 " \
                 ...
                 "esi-clones.read_clones.v1 esi-characters.read_contacts.v1 esi-universe.read_structures.v1 " \
                 "esi-bookmarks.read_character_bookmarks.v1 esi-killmails.read_killmails.v1 " \
                 "esi-corporations.read_corporation_membership.v1 esi-assets.read_assets.v1 " \
                 "esi-planets.manage_planets.v1 esi-fleets.read_fleet.v1 esi-fleets.write_fleet.v1 " \
                 "esi-ui.open_window.v1 esi-ui.write_waypoint.v1 esi-characters.write_contacts.v1 " \
                 ...
                 "esi-location.read_online.v1 esi-contracts.read_character_contracts.v1 " \
                 "esi-clones.read_implants.v1 esi-characters.read_fatigue.v1 " \
                 "esi-killmails.read_corporation_killmails.v1 esi-corporations.track_members.v1 " \
                 "esi-wallet.read_corporation_wallets.v1 esi-characters.read_notifications.v1 " \
                 ...
                 "esi-corporations.read_medals.v1 esi-characters.read_titles.v1 " \
                 "esi-alliances.read_contacts.v1 esi-characters.read_fw_stats.v1 " \
                 "esi-corporations.read_fw_stats.v1 esi-characterstats.read.v1".split(' ')